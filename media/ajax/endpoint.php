...
if(isset($_GET['segment'])){
	...
	switch($_GET['segment']){
		case "board":
			//$q = $db->query("SELECT tr_users.id AS id, tr_users.lastname AS lname, CONCAT(SUBSTRING(tr_users.firstname,1,1),SUBSTRING(tr_users.lastname,1,1)) AS initials, (SELECT SUM(value) as v FROM tr_points WHERE user = tr_users.id) AS value, (SELECT SUM(total) FROM tr_uservalmonth WHERE user = tr_users.id) AS year, FLOOR(((SELECT SUM(value) as v FROM tr_points WHERE user = tr_users.id)*100)/(SELECT SUM(total) FROM tr_uservalmonth WHERE user = tr_users.id)) AS getstop, (SELECT id FROM tr_stops WHERE id = ABS((SELECT COUNT(*) FROM tr_stops)-getstop) LIMIT 1) AS stop, (SELECT x FROM tr_stops WHERE tr_stops.id = stop LIMIT 1) AS x, (SELECT y FROM tr_stops WHERE tr_stops.id = stop LIMIT 1) AS y, (SELECT z FROM tr_stops WHERE tr_stops.id = stop LIMIT 1) AS z, (SELECT month FROM tr_stops WHERE tr_stops.id = stop LIMIT 1) AS m, (SELECT month_part FROM tr_stops WHERE tr_stops.id = stop LIMIT 1) AS mp, (SELECT name as d FROM tr_dept WHERE id = tr_users.dept) AS dept, (((SELECT SUM(tr_points.value) AS v FROM tr_points WHERE user = tr_users.id)*100)/(SELECT SUM(tr_uservalmonth.total) FROM tr_uservalmonth WHERE tr_uservalmonth.user = tr_users.id)) AS percent, ((SELECT x FROM tr_stops WHERE tr_stops.id = stop LIMIT 1)*100)/656 AS xpercent, ((SELECT y FROM tr_stops WHERE tr_stops.id = stop LIMIT 1)*100)/1034 AS ypercent FROM tr_users ORDER BY percent, stop, value ASC");
			//$q = $db->query("SELECT tr_users.id AS id, tr_users.lastname AS lname, CONCAT(SUBSTRING(tr_users.firstname,1,1),SUBSTRING(tr_users.lastname,1,1)) AS initials, IFNULL((SELECT SUM(value) as v FROM tr_points WHERE user = tr_users.id),0) AS value, IFNULL((SELECT IFNULL(stop,0) FROM tr_userval WHERE user = tr_users.id ORDER BY ABS(max-IFNULL(value,0)) LIMIT 1),1) AS stop, (SELECT x FROM tr_stops WHERE tr_stops.id = stop LIMIT 1) AS x, (SELECT y FROM tr_stops WHERE tr_stops.id = stop LIMIT 1) AS y, (SELECT z FROM tr_stops WHERE tr_stops.id = stop LIMIT 1) AS z, (SELECT month FROM tr_stops WHERE tr_stops.id = stop LIMIT 1) AS m, (SELECT month_part FROM tr_stops WHERE tr_stops.id = stop LIMIT 1) AS mp, (SELECT slug as d FROM tr_dept WHERE id = tr_users.dept) AS dept, IFNULL((((SELECT SUM(tr_points.value) AS v FROM tr_points WHERE user = tr_users.id)*100)/(SELECT SUM(tr_uservalmonth.total) FROM tr_uservalmonth WHERE tr_uservalmonth.user = tr_users.id)),0) AS percent, ((SELECT x FROM tr_stops WHERE tr_stops.id = stop LIMIT 1)*100)/656 AS xpercent, ((SELECT y FROM tr_stops WHERE tr_stops.id = stop LIMIT 1)*100)/1034 AS ypercent FROM tr_users WHERE tr_users.invisible IS NULL ORDER BY percent, stop, value ASC");
			$q = $db->query("SELECT tr_users.id AS id, tr_users.lastname AS lname, CONCAT(SUBSTRING(tr_users.firstname,1,1),SUBSTRING(tr_users.lastname,1,1)) AS initials, IFNULL((SELECT (IFNULL(SUM(value),0)+IFNULL(SUM(correction_value),0)) as v FROM tr_points WHERE user = tr_users.id),0) AS value, IFNULL((SELECT IFNULL(stop,0) FROM tr_userval WHERE user = tr_users.id ORDER BY ABS(max-IFNULL(value,0)) LIMIT 1),1) AS stop, (SELECT x FROM tr_stops WHERE tr_stops.id = stop LIMIT 1) AS x, (SELECT y FROM tr_stops WHERE tr_stops.id = stop LIMIT 1) AS y, (SELECT z FROM tr_stops WHERE tr_stops.id = stop LIMIT 1) AS z, (SELECT month FROM tr_stops WHERE tr_stops.id = stop LIMIT 1) AS m, (SELECT month_part FROM tr_stops WHERE tr_stops.id = stop LIMIT 1) AS mp, (SELECT slug as d FROM tr_dept WHERE id = tr_users.dept) AS dept, IFNULL((((SELECT (SUM(IFNULL(tr_points.value,0))+SUM(IFNULL(tr_points.correction_value,0))) AS v FROM tr_points WHERE user = tr_users.id)*100)/(SELECT SUM(tr_uservalmonth.total) FROM tr_uservalmonth WHERE tr_uservalmonth.user = tr_users.id)),0) AS percent, ((SELECT x FROM tr_stops WHERE tr_stops.id = stop LIMIT 1)*100)/656 AS xpercent, ((SELECT y FROM tr_stops WHERE tr_stops.id = stop LIMIT 1)*100)/1034 AS ypercent FROM tr_users WHERE tr_users.invisible IS NULL ORDER BY percent, stop, value ASC");
			echo $db->error;
			$nr = array();
