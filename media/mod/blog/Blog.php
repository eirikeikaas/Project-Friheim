...
class Blog extends Model{
	...
	public static function insert(){
		list($author, $body, $title) = func_get_args();
		$c_title = DB::escape($title);
		$c_author = DB::escape($author);
		$c_body = DB::escape($body);

		return DB::set("INSERT INTO ".System::getConfig('blogTable')."(title, author, timestamp, changed, body) VALUES ('$c_title', $c_author, NOW(), NOW(), '$c_body')");
	}
